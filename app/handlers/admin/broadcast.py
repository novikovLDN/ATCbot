...
def _gift3m_info_text_and_keyboard() -> tuple[str, InlineKeyboardMarkup]:
    ...
    text = (
        ...
        "🌐 10 ГБ Pro-режима строгих фильтров в подарок\n"
        ...
        f"📊 <b>{combo_basic_gb} ГБ</b> Pro-режима строгих фильтров (Pro) в пакете\n"
        "👨‍👩‍👧‍👦 До 5 устройств одновременно\n"
        ...
        f"📊 <b>{combo_plus_gb} ГБ</b> Pro-режима строгих фильтров (Pro) в пакете\n"
