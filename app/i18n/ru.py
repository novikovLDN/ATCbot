...
LANG = {
    ...
    'help.faq_a1': "🚫 <b>Не работает VPN</b>\n\n<blockquote>1️⃣ Проверьте интернет — отключите VPN и откройте любой сайт. Если интернета нет — проблема не в нас.\n\n2️⃣ Если в вашем регионе глушат связь — в приложении выберите сервер с пометкой <b>LTE</b> (специальный сервер обхода).\n\n3️⃣ Перезапустите приложение или импортируйте подписку заново через кнопку «📲 Подключиться» в боте.</blockquote>\n\nЕсли не помогло — напишите в поддержку 💬",
    'help.faq_a2': "📲 <b>Как подключиться</b>\n\n<blockquote>На главном экране нажмите «📲 Подключиться» и выберите своё устройство — мы покажем пошагово:\n\n• какое приложение установить\n• как одной кнопкой импортировать ключ\n• как запустить VPN\n\nВся настройка займёт меньше минуты.</blockquote>",
    'help.faq_a3': "🐌 <b>Низкая скорость</b>\n\n<blockquote>1️⃣ Попробуйте другой сервер в приложении — иногда соседние страны быстрее.\n\n2️⃣ Проверьте скорость интернета <b>без VPN</b>. Если базовое соединение медленное — ускорить через VPN нельзя.\n\n3️⃣ На LTE/5G скорость зависит от загрузки ближайшей вышки и времени суток. В часы пик — может быть медленнее.</blockquote>\n\nЕсли стабильно низкая скорость на всех серверах — напишите в поддержку 💬",
    'help.faq_a4': "💳 <b>Не проходит оплата</b>\n\n<blockquote>1️⃣ Попробуйте другой способ — СБП / Telegram Stars / банковская карта / с баланса бота.\n\n2️⃣ Если банк блокирует — пополните баланс бота (например, через Stars) и оплатите им.\n\n3️⃣ Если платёж завис — подождите 10–15 минут. Деньги либо спишутся, либо вернутся автоматически.</blockquote>\n\nДеньги списали, но подписка не пришла? — напишите в поддержку 💬",
    'help.faq_a5': "📱 <b>Как добавить ещё устройство</b>\n\n<blockquote>Одна подписка работает сразу на нескольких устройствах:\n\n• <b>Basic</b> — до 5 устройств\n• <b>Plus</b> — до 7 устройств\n\nПросто откройте бота на новом устройстве, нажмите «📲 Подключиться» и импортируйте ту же подписку. Доплачивать не нужно.</blockquote>",
