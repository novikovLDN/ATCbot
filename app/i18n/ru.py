...
LANG = {
    ...
    'setup.key_bypass': "🔑 <b>Pro-ключ</b> (полный доступ):",
    ...
    'profile.key_whitelist': "⚪️ Скопировать Pro-ключ",
