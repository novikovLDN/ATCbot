...
LANG = {
    ...
    'bypass_setup.title': (
        ...
        "Открой один из клиентов — установка занимает 30 секунд, ключ "
        "уже сгенерирован и работает.\n\n"
        "<b>📲 Happ</b> — универсальный клиент, работает на iOS / Android / macOS / Windows.\n"
        "<b>💚 Incy</b> — быстрый клиент с классным UX.\n\n"
        "Нажми «➕ Добавить обход» — Telegram сам откроет клиент и "
        "импортирует ключ. Если по какой-то причине не открылось — "
        "«🔑 Показать ключ вручную» и вставь его в клиент из буфера."
    ),
    ...
    'bypass_setup.no_key_yet': (
        "⏳ Ключ обхода ещё не готов. Обычно занимает не более минуты — "
        "загляни сюда чуть позже."
    ),
    'bypass_setup.manual_screen': (
        "🔑 <b>Ключ обхода</b>\n\n"
        "1. Нажми на ключ ниже — он скопируется.\n"
        "2. Открой Happ или Incy → иконка буфера / кнопка «Вставить».\n\n"
