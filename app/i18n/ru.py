...
LANG = {
    ...
    'biz.btn_copy_link': '🔗 Скопировать ссылку подключения',
    ...
    'setup.no_subscription': '🔑 <b>Пока нечего подключать</b>\n\nКлюч появится сразу после оформления подписки — тогда этот экран установит приложение и настроит его в два нажатия.',
    ...
    'games.monthly_cap_reached': "Месячный лимит бонусных дней уже выбран ({cap} дн.). Следующие бонусы — в новом месяце.",
    ...
    # ── Ферма и шторм: экраны, кнопки и алерты (2026-08) ──
    # Раньше вся ферма была собрана из русских литералов в коде, и
    # пользователь с любым другим языком видел русский экран целиком.
    'farm.storm_banner': '⛈ <b>Надвигается шторм!</b> До удара ≈ {hours} ч\nРастущие грядки без плёнки погибнут.\n🚫 <b>Посадка новых растений недоступна до конца шторма.</b>\n',
    'farm.button_plant_storm_blocked': '🚫 Грядка {num}: посадка во время шторма недоступна',
    'farm.button_shield': '🛡 Накрыть #{num} — {price} ₽',
    'farm.button_early': '🚜 Собрать незрелым #{num} — +{reward} ₽',
    'farm.button_dig': '⛏ Выкопать #{num}',
    'farm.button_buy_plot_slots': '➕ Купить грядку — {price} ₽ (осталось мест: {slots})',
    'farm.button_buy_plot_slots_disabled': '➕ Грядка (нужно {price} ₽, осталось мест: {slots})',
    'farm.button_guide': '📖 Инструкция',
    'farm.paywall': '🌾 Ферма доступна только подписчикам.\nОформите подписку, чтобы вернуться к грядкам.',
    'farm.storm_planting_blocked': '🚫 Идёт шторм — посадка временно недоступна. После шторма можно будет сажать снова.',
    'farm.error_already_harvested': 'Эта грядка уже собрана',
    'farm.error_boost_limit': 'Быстрее уже не получится: ускорение этого растения на пределе.',
    'farm.dig_unavailable': '❌ Растение недоступно для выкапывания',
    'farm.dig_confirm': '⛏ <b>Выкопать растение?</b>\n\nВы хотите выкопать <b>{name}</b> на грядке {num}?\n\n⚠️ Растение будет уничтожено без награды.\nГрядка станет пустой и можно будет посадить новое растение.',
    'farm.dig_yes': '⛏ Да, выкопать',
    'farm.dig_success': '⛏ Растение выкопано! Грядка свободна.',
    'farm.error_plot_not_found': '❌ Грядка не найдена',
    'farm.shield_no_storm': 'Шторм уже прошёл или ещё не объявлен.',
    'farm.shield_plot_not_growing': 'Грядка больше не растёт.',
    'farm.shield_already': 'Грядка уже накрыта.',
    'farm.shield_applied': '🛡 Грядка накрыта (−{price} ₽)',
    'farm.shield_failed': 'Не удалось накрыть грядку. Попробуйте ещё раз.',
    'farm.shield_payment_title': '🛡 <b>Накрытие грядки {num}</b>\n\nРастение: {emoji} {name}\nЦена плёнки: <b>{price} ₽</b>\nНа балансе: {balance} ₽ — на плёнку не хватает.\n\n⚠️ Счёт выставляется на полную стоимость плёнки — {price} ₽. Баланс при оплате картой или через СБП не списывается и остаётся у вас.\n\nВыберите способ оплаты:',
    'farm.shield_invoice_too_late': '⏳ До шторма меньше {minutes} мин — платёж не успеет дойти, и плёнка не спасёт грядку.\n\nНакрыть ещё можно с баланса, если на нём хватает денег.',
    'farm.pay_card': '💳 Картой',
    'farm.pay_sbp': '📲 СБП',
    'farm.back_to_farm': '🔙 На ферму',
    'farm.pay_card_unavailable': 'Оплата картой временно недоступна.',
    'farm.pay_sbp_unavailable': 'СБП временно недоступен.',
    'farm.pay_error': 'Ошибка создания платежа.',
    'farm.shield_lava_invoice': '💳 <b>Оплата накрытия грядки</b>\n\nСумма: {amount} ₽\n\nПосле оплаты грядка накроется автоматически.',
    'farm.shield_lava_button': '💳 Перейти к оплате',
    'farm.shield_sbp_invoice': '📲 <b>СБП — накрытие грядки</b>\n\nСумма с учётом наценки: {amount} ₽\n\nПосле оплаты грядка накроется автоматически.',
    'farm.shield_sbp_button': '📲 Оплатить через СБП',
    'farm.shield_invoice_comment': 'Atlas Secure — Накрытие грядки {num}',
    'farm.early_no_storm': 'Ранний сбор доступен только во время шторма.',
    'farm.early_unavailable': 'Ранний сбор недоступен для этого растения.',
    'farm.early_failed': 'Не удалось зачислить награду.',
    'farm.early_success': '🚜 Собрано {emoji} незрелым: +{reward} ₽',
    'farm.plant_tomato': 'Томаты',
    'farm.plant_potato': 'Картофель',
    'farm.plant_carrot': 'Морковь',
    'farm.plant_cactus': 'Кактус',
    'farm.plant_apple': 'Яблоня',
    'farm.plant_lavender': 'Лаванда',
    'farm.plant_greens': 'Зелень',
    'farm.plant_pepper': 'Перчик',
    'farm.plant_cucumber': 'Огурец',
    'farm.plant_sunflower': 'Подсолнух',
    'farm.plant_strawberry': 'Клубника',
    'farm.plant_grape': 'Виноград',
    'farm.plant_cherry': 'Вишня',
    'farm.plant_lemon': 'Лимонное дерево',
    'farm.plant_oak': 'Дуб',
