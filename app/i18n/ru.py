...
LANG = {
    ...
    'setup.key_vpn_label': "🔑 <b>VPN ключ</b> (обычные сервера):",
    'setup.key_bypass_label': "🔑 <b>Pro-режим ключ</b> (строгий фильтр РФ):",
    ...
    'setup.qr_bypass_btn': "Pro-режим строгих фильтров",
    'setup.qr_bypass_unavailable': "❌ Pro-режим строгих фильтров недоступен.\n\nУбедитесь, что у вас есть активная подписка и трафик Pro-режима.",
    'setup.qr_instruction': "📲 <b>Добавить устройство</b>\n\n<b>По QR-коду:</b>\nОтсканируйте код выше в приложении:\n├ <b>Happ</b> → 📸 иконка камеры\n├ <b>V2RayTun</b> → <b>+</b> → «Сканировать QR»\n└ <b>Hiddify</b> → <b>+</b> → «Сканировать QR»\n\n<b>Вручную:</b>\nНажмите на ключ ниже — он скопируется, затем:\n├ <b>Happ</b> → иконка буфера внизу\n├ <b>V2RayTun</b> → <b>+</b> → «Импорт из буфера»\n└ <b>Hiddify</b> → <b>+</b> → «Из буфера обмена»",
    ...
    'setup.install_app': "📲 <b>Осталось скачать приложение</b>\n\nHapp — бесплатное приложение для VPN.\nНажмите кнопку — откроется магазин приложений.",
    'setup.install_app_v2ray_hint': "\n\n<blockquote>Уже есть Happ или V2RayTun? Нажмите «Дальше».</blockquote>",
    ...
    'main.trial_notification_6h': "👋 Рады что вы с нами!\n\nВаш VPN активен и защищает вас прямо сейчас. Попробуйте открыть YouTube, Instagram или любой ограниченный сайт — всё работает без ограничений 🌍",
    ...
    'referral.screen_title': "💎 Программа лояльности",
    'referral.share_button': "📤 Пригласить",
    'referral.share_link_button': "📤 Поделиться ссылкой",
    'referral.stats_button': "📊 Статистика",
    ...
    'traffic.warning_low': "Осталось {remaining} трафика Pro-режима",
    'traffic.warning_critical': "Трафик Pro-режима почти закончился!",
    'traffic.subscription_expired_bypass_active': "⚠️ <b>Ваша основная подписка закончилась</b>\n\nPro-режим строгих ограничений продолжает работать — ваши ГБ на месте.\n\nНе забудьте докупить трафик, если он заканчивается 👇",
    ...
    'traffic.bypass_activated': "✅ <b>Pro-режим строгих ограничений активирован!</b>\n\n📦 +{gb} ГБ трафика начислено\n\n💡 <i>Трафик не сгорает — накапливается между покупками.</i>\n\nОткройте <b>Личный кабинет</b> чтобы получить ключ подключения.",
    'traffic.bypass_activated_trial': "✅ <b>Pro-режим строгих ограничений активирован!</b>\n\n📦 +{gb} ГБ трафика начислено\n\n🎁 <b>Бонус:</b> Пробный период VPN (3 дня) активирован!\n\n💡 <i>Трафик не сгорает — накапливается между покупками.</i>\n\nОткройте <b>Личный кабинет</b> чтобы получить ключ подключения.",
    'traffic.bypass_provisioning': "⏳ Настраиваем Pro-режим строгих ограничений...\nНажмите 🔄 через несколько секунд.",
    'combo.purchase_success': "✅ <b>Комбо-подписка активирована!</b>\n\n📦 Тариф: <b>Комбо {tariff}</b> · {months} мес.\n🌐 Pro-режим: <b>{gb} ГБ</b> начислено\n\nНажмите «Подключиться» чтобы настроить устройство.",
    'traffic.notify_8gb': "<tg-emoji emoji-id=\"5456140674028019486\">💡</tg-emoji> Осталось {remaining} трафика Pro-режима.\n\nМожно докупить заранее — трафик не сгорает.",
    'traffic.notify_5gb': "<tg-emoji emoji-id=\"5190806721286657692\">📉</tg-emoji> Осталось {remaining} трафика Pro-режима.\n\nРекомендуем пополнить, чтобы Pro-режим работал без перебоев.",
    'traffic.notify_3gb': "<tg-emoji emoji-id=\"5190806721286657692\">⚠️</tg-emoji> Осталось {remaining} трафика Pro-режима 🇷🇺\n\nКупите дополнительный трафик, чтобы Pro-режим продолжал работать.",
    'traffic.notify_1gb': "<tg-emoji emoji-id=\"5190806721286657692\">🔴</tg-emoji> Менее 1 ГБ трафика Pro-режима! Скоро Pro-режим отключится.",
    'traffic.notify_500mb': "<tg-emoji emoji-id=\"5190806721286657692\">❗️</tg-emoji> Осталось {remaining} трафика Pro-режима!",
    'traffic.notify_zero': "<tg-emoji emoji-id=\"5190806721286657692\">🚫</tg-emoji> Трафик Pro-режима закончился.\n\nAtlas Fast 🇩🇪 продолжает работать без ограничений.",

    # --- Bypass-only purchase ---
    'bypass.buy_title': "🌐 <b>Pro-режим строгих фильтров 🇷🇺</b>\n\nДоступ к ограниченным сайтам через новейший протокол Pro-режима.\nОплата только за трафик — без ежемесячных платежей.\n\n<blockquote>📊 Примерный расход:\n├ 15 ГБ — ~1.5 мес.\n├ 25 ГБ — ~2.5 мес.\n├ 45 ГБ — ~4 мес.\n├ 60 ГБ — ~6 мес.\n└ 120 ГБ — ~1 год</blockquote>\n\n💡 Текст и фото — мало. Видео и Reels — больше.",
    ...
    'bypass.purchase_success': "✅ <b>Pro-режим строгих фильтров активирован!</b>\n\n📦 +{gb} ГБ трафика начислено",
    'bypass.trial_activated': "<tg-emoji emoji-id=\"5449800250032143374\">🎁</tg-emoji> <b>Бонус:</b> Пробный период основной подписки (3 дня) активирован!\n\nПо истечении пробного периода Pro-режим строгих фильтров продолжит работать.\nОсновную подписку можно приобрести отдельно.",

    # --- Combo subscription ---
    'combo.screen_title': "🚀 <b>Комбо-подписка</b>\n\nОсновные сервера + Pro-режим строгих фильтров в одном пакете.\nВыберите тариф:",
    'combo.tariff_basic': "⚡ <b>Комбо Basic</b>\n\n<blockquote>🌐 Основные сервера (безлимит) · до 25 Гбит/с\n🌐 Pro-режим строгих фильтров + трафик в комплекте\n👨‍👩‍👧‍👦 Одна подписка на всю семью — до 5 устройств</blockquote>\n\n📊 <b>Пакет — это ваш личный запас ГБ</b>\n<blockquote>Не сгорает по времени и не привязан к подписке — тратится только когда вы реально пользуетесь серверами с пометкой <b>Pro</b>.</blockquote>\n\n<i>Закончится — пополните, когда удобно</i> ⭐️",
    ...
    'combo.period_1': "1 мес · {gb} ГБ Pro-режима · {price} ₽",
    'combo.period_3': "3 мес · {gb} ГБ Pro-режима · {price} ₽",
    'combo.period_6': "6 мес · {gb} ГБ Pro-режима · {price} ₽",
    'combo.period_12': "12 мес · {gb} ГБ Pro-режима · {price} ₽",
    'combo.period_24': "24 мес · {gb} ГБ Pro-режима · {price} ₽",

    # Bypass gift links — user-facing redemption messages
    'bypass_gift.activated': "🎁 <b>Подарок активирован!</b>\n\nВам начислено <b>{gb} ГБ</b> трафика Pro-режима.\n\nГБ уже доступны и работают независимо от срока подписки. Откройте раздел «Включить Pro-режим», чтобы использовать их.",
    ...
    'bgift_setup.select_device': "📱 <b>Выберите устройство</b>\n\nПодключим Pro-режим в две короткие шага. Сначала выберите, на каком устройстве будете пользоваться.",
    'bgift_setup.connect_screen': (
        "⚡️ <b>Подключитесь в одно нажатие</b>\n\n"
        "Добавьте ключ для полноценной работы.\n\n"
        "🌐 <b>Pro-режим</b> — строгий фильтр РФ, интернет работает в любой точке мира.\n\n"
        "<b>Ваш ключ Pro-режима:</b>\n"
        "<blockquote><code>{sub_url}</code></blockquote>\n"
        ...
        "<b>В V2RayTun:</b>\n"
        "1. Откройте V2RayTun\n"
        "2. Нажмите <b>+</b> и выберите <b>«Импорт из буфера»</b>\n"
        "3. Выберите добавленный профиль\n"
        "4. Включите соединение\n\n"
        "<blockquote>💡 Кнопки «Добавить ключ» сверху сделают это автоматически — без копирования.</blockquote>"
    ),
    'bgift_setup.connect_no_key': (
        "⚡️ <b>Подключитесь в одно нажатие</b>\n\n"
        "🌐 <b>Pro-режим</b> — строгий фильтр РФ, интернет работает в любой точке мира.\n\n"
        "⚠️ Не удалось получить ваш ключ Pro-режима. "
