...
LANG = {
    ...
    # --- Help / FAQ ---
    'help.menu_title': "❓ <b>Помощь</b>\n\nЧем вам помочь? Выберите подходящий вариант:\n\n<blockquote>📖 <b>Ответы на частые вопросы</b> — короткие решения типичных проблем\n📲 <b>Инструкции по сервису</b> — как настроить VPN на вашем устройстве\n💬 <b>Помощь</b> — написать живому оператору в Telegram</blockquote>",
    ...
    'help.faq_a1': "🚫 <b>Не работает VPN</b>\n\nПройдитесь по шагам — обычно помогает один из них:\n\n<blockquote>1️⃣ <b>Проверьте интернет без VPN</b>\nОтключите VPN в приложении, откройте любой сайт. Не работает — проблема у вашего провайдера, не у нас.\n\n2️⃣ <b>В регионе глушат связь?</b>\nВ приложении выберите сервер с пометкой <b>LTE</b> — он специально для обхода блокировок мобильных операторов (МТС, МегаФон, Билайн).\n\n3️⃣ <b>Перезапустите приложение</b>\nПолностью закройте Happ (смахните из меню) → откройте заново → включите подключение.\n\n4️⃣ <b>Импортируйте ключ заново</b>\nВ боте: «📲 Подключиться» → выберите устройство → «Импортировать ключ». Возможно, ссылка обновилась.</blockquote>\n\nЕсли ничего не помогло — напишите оператору, ответим за 5–10 минут 💬",
    'help.faq_a2': "📲 <b>Как подключиться</b>\n\nЭто занимает меньше минуты:\n\n<blockquote>1️⃣ В боте нажмите <b>«📲 Подключиться»</b>\n\n2️⃣ Выберите ваше устройство — iPhone, Android, Mac или Windows\n\n3️⃣ Установите приложение по нашей ссылке (App Store / Google Play / сайт)\n\n4️⃣ Нажмите <b>«Импортировать ключ»</b> в боте — подписка добавится в приложение автоматически\n\n5️⃣ Включите VPN в приложении 🚀</blockquote>\n\n💡 Все шаги показаны с картинками — заблудиться сложно.\nЕсли что-то не получается — напишите в поддержку 💬",
    'help.faq_a3': "🐌 <b>Низкая скорость</b>\n\nПройдитесь по шагам:\n\n<blockquote>1️⃣ <b>Проверьте скорость без VPN</b>\nОткройте <code>speedtest.net</code> с выключенным VPN. Если базовый интернет медленный — ускорить через VPN физически невозможно.\n\n2️⃣ <b>Смените сервер</b>\nВ приложении переключитесь на другой — иногда соседние страны работают быстрее (например, Германия вместо Нидерландов).\n\n3️⃣ <b>Используете LTE/5G?</b>\nСкорость мобильного интернета зависит от загрузки ближайшей вышки и времени суток. Вечером в спальных районах — медленнее, ночью — быстрее.\n\n4️⃣ <b>Перезагрузите Wi-Fi-роутер</b>\nИногда зависает именно роутер, а не VPN. Отключите от розетки на 30 секунд → включите.</blockquote>\n\nСтабильно медленно на всех серверах — напишите оператору 💬",
    'help.faq_a4': "💳 <b>Не проходит оплата</b>\n\nПройдитесь по шагам:\n\n<blockquote>1️⃣ <b>Смените способ оплаты</b>\nДоступно несколько: СБП → банковская карта → Telegram Stars → баланс бота. Если один не работает — попробуйте другой.\n\n2️⃣ <b>Банк блокирует платёж?</b>\nПополните баланс бота через Telegram Stars (звёзды покупаются через Apple Pay / Google Pay напрямую в Telegram) — затем оплатите подписку из баланса.\n\n3️⃣ <b>Платёж завис на 10 минут?</b>\nПодождите 10–15 минут. Деньги либо спишутся и подписка активируется, либо вернутся на карту автоматически — мы ничего не «зажимаем».\n\n4️⃣ <b>Деньги списали, подписки нет?</b>\nОткройте «👤 Профиль» → «История платежей». Если транзакции там нет — напишите в поддержку с чеком из банка, восстановим вручную в течение часа.</blockquote>\n\n💬 Поддержка ответит за 5–10 минут.",
    'help.faq_a5': "📱 <b>Как добавить ещё устройство</b>\n\nОдна подписка работает сразу на нескольких устройствах:\n\n<blockquote>• <b>Basic</b> — до 5 устройств одновременно\n• <b>Plus</b> — до 7 устройств одновременно</blockquote>\n\n<b>Как добавить новое устройство:</b>\n\n<blockquote>1️⃣ Откройте нашего бота на новом устройстве (можно через тот же Telegram-аккаунт)\n\n2️⃣ Нажмите <b>«📲 Подключиться»</b>\n\n3️⃣ Выберите тип устройства\n\n4️⃣ Установите рекомендованное приложение\n\n5️⃣ Нажмите <b>«Импортировать ключ»</b> — подписка добавится автоматически</blockquote>\n\n💡 Доплачивать не нужно — это <b>та же</b> подписка, просто на другом устройстве.",
