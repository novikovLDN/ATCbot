...
LANG = {
    ...
    'profile.status_pending': "⏳ Подписка: активируется — ключ будет готов через минуту",
    'profile.tariff_trial': "🎁 Пробный",
    'profile.panel_unavailable': "\n\n⚠️ <i>Данные панели временно недоступны: показаны данные из базы, остаток трафика обхода не обновлён.</i>",
    'main.my_sub_pending': "активируется…",
