...
LANG = {
    ...
    'setup.key_bypass_label': "🔑 <b>Pro-ключ Happ</b> (полный доступ):",
    'setup.key_vpn_incy_label': "💚 <b>VPN ключ Incy</b> (обычные безлимитные сервера):",
    'setup.key_bypass_incy_label': "💚 <b>Pro-ключ Incy</b> (полный доступ):",
    ...
    'setup.qr_bypass_btn': "Pro-доступ",
    'setup.qr_bypass_unavailable': "❌ Pro-доступ недоступен.\n\nУбедитесь, что у вас есть активная подписка и Pro-трафик.",
    ...
    'main.smart_notif_3days_usage': "Atlas Secure работает на полной скорости\nи не требует продлений вручную\nдо окончания срока доступа.",
    ...
    'main.trial_notification_6h': "👋 Рады что вы с нами!\n\nВаш VPN активен и защищает вас прямо сейчас. Попробуйте открыть YouTube, Instagram или любой другой сайт — всё работает на полной скорости 🌍",
    ...
    'trial.bypass_activated': (
        "🛡 <b>Pro-доступ подключён</b>\n\n"
        "Мы дали <b>500 МБ Pro-трафика</b> в подарок — с ним "
        "открываются все сайты и сервисы на полной скорости.\n\n"
    ...
    'traffic.info': "<tg-emoji emoji-id=\"5190806721286657692\">📊</tg-emoji> <b>Pro-доступ</b> 🇷🇺\n\n<tg-emoji emoji-id=\"5443127283898405358\">📥</tg-emoji> {used} / {limit}\n{bar} {pct}%\n\n<tg-emoji emoji-id=\"5454415424319931791\">⏳</tg-emoji> До: {expires}\n\n<tg-emoji emoji-id=\"5271604874419647061\">🔗</tg-emoji> <b>Pro-ключ</b> <i>(нажми — скопируется)</i>\n<blockquote expandable><code>{sub_url}</code></blockquote>\n\n📲 <b>Куда вставить:</b>\n└ <b>Happ</b> → Главная → <b>+</b> → Вставить из буфера",
    'traffic.no_subscription': "📊 <b>Pro-доступ</b> 🇷🇺\n\n🔒 Нет активной подписки.",
    'traffic.trial_no_bypass': "📊 <b>Pro-доступ</b> 🇷🇺\n\n🔒 Pro доступен на тарифах Basic и Plus.",
    'traffic.trial_upgrade_hint': "Купите подписку Basic или Plus, чтобы получить больше ГБ и возможность докупать трафик",
    'traffic.not_provisioned': "📊 Pro-доступ пока не настроен. Попробуйте позже.",
    ...
    'combo.period_1': "1 мес · {gb} ГБ Pro · {price} ₽",
    'combo.period_3': "3 мес · {gb} ГБ Pro · {price} ₽",
    'combo.period_6': "6 мес · {gb} ГБ Pro · {price} ₽",
    'combo.period_12': "12 мес · {gb} ГБ Pro · {price} ₽",
    'combo.period_24': "24 мес · {gb} ГБ Pro · {price} ₽",
    ...
    'bgift_setup.select_device': "📱 <b>Выберите устройство</b>\n\nПодключим Pro в две короткие шага. Сначала выберите, на каком устройстве будете пользоваться.",
    'bgift_setup.connect_screen': (
        "⚡️ <b>Подключитесь в одно нажатие</b>\n\n"
        "Добавьте ключ для полноценной работы.\n\n"
        "🌐 <b>Pro-доступ</b> — интернет работает на полной скорости в любой точке мира.\n\n"
        "<b>Ваш Pro-ключ:</b>\n"
