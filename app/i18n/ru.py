...
LANG = {
    ...
    'referral.how_it_works_text': "📊 Как работает Круг Амбассадоров\n\n1. Отправьте другу вашу амбассадорскую ссылку\n2. Друг переходит по ссылке и регистрируется\n3. Когда друг оплачивает подписку, вам начисляется кешбэк\n\n<tg-emoji emoji-id=\"5449800250032143374\">🎁</tg-emoji> Уровни кешбэка:\n• 0–24 купивших → <b>Проводник</b> · 10%\n• 25–49 → <b>Хранитель</b> · 20%\n• 50–74 → <b>Инсайдер</b> · 30%\n• 75–99 → <b>Лидер</b> · 40%\n• 100+ → <b>Амбассадор</b> · 45% навсегда 👑\n\n💰 Кешбэк начисляется автоматически на ваш баланс\nс <b>каждой</b> покупки реферала, включая продления.\n\n💡 Уровень определяется по количеству рефералов,\nкоторые ХОТЯ БЫ ОДИН РАЗ оплатили подписку. Уровень только растёт и не падает.",
