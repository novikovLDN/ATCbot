...
LANG = {
    ...
    'start_trial.received': "🎁 Пробная подписка активирована!\n\nВам доступно:\n• 3 дня доступа\n• безлимитный VPN\n• 1 ГБ для обхода БС\n\nНажав кнопку «Подключиться», вы подтверждаете, что прочитали и согласны с <a href=\"https://telegra.ph/Polzovatelskoe-soglashenie-08-06-50\">пользовательским соглашением</a>.",
    'start_trial.btn_connect': "🚀 Подключиться",
    'start_trial.btn_terms': "📄 Пользовательское соглашение",
    'start_trial.already_active': "Ваша подписка уже активна. Открываем главное меню.",
    ...
    'trial.bypass_activated': (
        ...
        "Мы дали <b>1 ГБ трафика обхода</b> в подарок — с ним "
