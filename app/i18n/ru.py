...
LANG = {
    ...
    'setup.qr_bypass_btn': "Pro",
    'setup.qr_bypass_unavailable': "❌ Pro недоступен.\n\nУбедитесь, что у вас есть активная подписка и Pro-трафик.",
    ...
    'trial.bypass_activated_btn_setup': "🌐 Включить Pro",
    ...
    'bypass_setup.title': (
        ...
        "2. Нажми <b>«➕ Добавить Pro»</b> — Telegram откроет клиент "
        "и импортирует ключ автоматически.\n"
        "3. Не открылось? Нажми <b>«🔑 Показать ключ вручную»</b>, "
        "скопируй ключ и вставь в клиент из буфера."
    ),
    'bypass_setup.add_happ_btn': "➕ Добавить Pro в Happ",
    'bypass_setup.add_incy_btn': "➕ Добавить Pro в Incy",
    ...
    'bypass_setup.manual_screen_footer': (
        ...
        "кнопку <b>«➕ Добавить Pro»</b>. Она открывает клиент напрямую "
        "через deeplink."
    ),
    ...
    'help.faq_q8': "📊 Как работают гигабайты Pro",
    ...
    'traffic.buy_gb_btn': "📈 Докупить ГБ Pro",
    ...
    'bypass_gift.activated': "🎁 <b>Подарок активирован!</b>\n\nВам начислено <b>{gb} ГБ</b> Pro-трафика.\n\nГБ уже доступны и работают независимо от срока подписки. Откройте раздел «Включить Pro», чтобы использовать их.",
    ...
    'main.my_sub_btn_topup_gb': "Пополнить ГБ Proа",
