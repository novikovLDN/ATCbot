...
LANG = {
    ...
    'help.faq_a8': "📊 <b>Как работают гигабайты обхода</b>\n\nГигабайты для серверов обхода — это <b>отдельный пакет трафика</b>. Покупаете один раз и тратите в своём темпе.\n\n<blockquote>♾ <b>Без срока годности</b>\nНе сгорают. Не привязаны к месяцу, дню или подписке. Сколько использовали — столько и списалось, остаток остаётся вам.</blockquote>\n\n<blockquote>🔓 <b>Независимо от подписки</b>\nЭто <b>не</b> часть основной подписки на VPN. Подписка закончилась — гигабайты обхода остаются на счёте и ждут вас.</blockquote>\n\n<b>Пример</b>\n\n<blockquote>💰 Купили <b>30 ГБ</b>\n📉 За неделю израсходовали <b>5 ГБ</b>\n✅ Остаток — <b>25 ГБ</b>\n\nЭти 25 ГБ никуда не денутся: используйте завтра, через месяц или через полгода.</blockquote>\n\n<b>Где посмотреть остаток</b>\n\n<blockquote>📱 В приложении <b>Happ</b> или <b>V2RayTun</b> — рядом с подключением к серверу обхода\n\n👤 В <b>боте</b> — раздел <b>«👤 Профиль»</b></blockquote>\n\n<i>Закончились? Докупите в любой момент — новые ГБ просто прибавятся к остатку.</i> 💬",

    # --- Winback "2-day gift + 20% discount" campaign ---
    'winback.notif_text': "🎁 <b>Вернулись к вам с подарком</b>\n\nЗаметили, что ваша подписка закончилась несколько дней назад — захотели вернуть вас красиво.\n\n<blockquote>✅ <b>2 дня VPN — уже на счёте</b>\nПодписка снова активна. Откройте приложение и подключайтесь прямо сейчас — бесплатно.\n\n⚡ <b>+ скидка 20% на 7 дней</b>\nНа любую следующую подписку. Скидка уже привязана к вашему аккаунту — она применится автоматически при оплате, ничего вводить не нужно.</blockquote>\n\n<i>Без подвохов, без условий, без авто-списаний.</i>\n\nЭто наш способ сказать <b>спасибо</b>, что вы были с нами. И тихая надежда, что вы вернётесь 🤍",
    'winback.claim_button': "🎁 Забрать скидку",

    # --- Winback admin UI ---
    'winback.admin_menu_button': "🎁 Винбэк: 2 дня + 20%",
    'winback.admin_preview_title': "🎁 <b>Винбэк-кампания «2 дня + 20%»</b>\n\nЦель: вернуть пользователей, у которых VPN-подписка закончилась за последние 3 дня и осталось ≤1 ГБ bypass-трафика.\n\nКаждому будет:\n<blockquote>• выдано 2 дня подписки <b>basic</b> (через grant_access, source='gift')\n• оформлена скидка <b>20%</b> на 7 дней (user_discounts)\n• отправлено уведомление с кнопкой «🎁 Забрать скидку»</blockquote>",
    'winback.admin_preview_stats': "<b>Кандидаты на отправку прямо сейчас</b>\n\n<blockquote>📋 Истёкших за 3 дня (без bypass-only): <b>{raw}</b>\n🎯 После фильтра bypass ≤1 ГБ: <b>{filtered}</b>\n⛔ Отфильтровано (трафика >1 ГБ): <b>{dropped}</b></blockquote>\n\n<i>Кнопка ниже запускает рассылку. Повторный запуск пропустит уже обработанных пользователей (дедуп по флагу в БД).</i>",
    'winback.admin_run_button': "🚀 Запустить рассылку",
    'winback.admin_running': "⏳ <b>Кампания запущена</b>\n\nОбрабатываем {count} пользователей. Это займёт ~{eta_sec} сек. Отчёт придёт сюда же.",
    'winback.admin_done': "✅ <b>Кампания завершена</b>\n\n<blockquote>📋 Кандидатов: <b>{raw}</b>\n🎯 После фильтра bypass: <b>{filtered}</b>\n\n🎁 Доставлено: <b>{delivered}</b>\n⚠️ Не удалось выдать подарок: <b>{gift_failed}</b>\n📨 Не удалось доставить сообщение: <b>{send_failed}</b></blockquote>\n\n⏱ Длительность: {duration:.1f} сек",
    'winback.admin_no_candidates': "📭 <b>Сейчас никого нет</b>\n\nНи у одного пользователя подписка не закончилась за последние 3 дня (или все уже получили эту кампанию).",
