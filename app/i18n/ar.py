...
LANG = {
    ...
    'games.bowling_strike_success': "🎳 سترايك! تم إسقاط جميع الكرات!\n\n🎉 تهانينا! فزت بـ +7 أيام اشتراك.\n\nالوصول حتى: {date}",
    'games.bowling_strike_error': "🎳 سترايك! تم إسقاط جميع الكرات!\n\n🎉 تهانينا! فزت بـ +7 أيام اشتراك.\n\n⚠️ خطأ في الإضافة. يرجى التواصل مع الدعم.",
    ...
    'main.trial_activated_text': '🔒 تم تفعيل الوصول التجريبي\n\nأنت محمي لمدة 3 أيام.\n\n🔑 مفتاح الاتصال:\n<code>{vpn_key}</code>\n\nاستخدمه في تطبيق VPN.\n\n⏰ صالح حتى: {expires_date}',
    ...
    'main.trial_expired_text': '🔓 انتهى الوصول التجريبي\n\nانتهت فترة التجربة.\n\n🎟 استخدم رمز الترويج YAbx30 للحصول على خصم 30% على اشتراكك الأول.\n\nاشترك الآن لمواصلة استخدام الوصول الآمن.',
    ...
    'payment.success_first': '🎉 تم تفعيل الاشتراك بنجاح\n\n📅 صالح حتى: {date}\n\n🔐 مفتاح الاتصال:\n<code>{vpn_key}</code>',
    'payment.success_renewal': '🔄 تم تجديد الاشتراك\n\n📅 صلاحية جديدة حتى: {date}\n\n🔐 مفتاحك الحالي (نفس UUID):\n<code>{vpn_key}</code>',
    ...
    'farm.choose_plant_title': '🌱 اختر نبتة للحقل {num}:',
    ...
    'gift.activated': '🎉 تم تفعيل الهدية!\n\n📦 الخطة: {tariff_name}\n⏳ المدة: {period}\n\nاشتراكك نشط الآن.\nاضغط «اتصال» للبدء.',
    'gift.activated_welcome': '🎉 مرحباً بك في Atlas Secure!\n\n🎁 تلقيت اشتراكاً هدية:\n📦 الخطة: {tariff_name}\n⏳ المدة: {period}\n\nالاشتراك نشط بالفعل.\nاختر لغة الواجهة:',
    ...
    'gift.choose_payment': '🎁 هدية — {tariff_name}\n\n📦 الخطة: {tariff_name}\n⏳ المدة: {period}\n💰 السعر: {price} ₽\n\nاختر طريقة الدفع:',
    'gift.choose_period': '🎁 هدية — {tariff_name}\n\nاختر مدة الاشتراك للهدية:',
    'gift.detail_activated': '🎁 {tariff_name} — {period}\n\n✅ هذه الهدية تم تفعيلها بالفعل.',
    'gift.detail_pending': '🎁 أرسل هذه الهدية لشخص عزيز!\n\n📦 الخطة: {tariff_name}\n⏳ المدة: {period}\n\n❌ غير مفعل\n\n🔗 رابط التفعيل:\n<code>{gift_link}</code>',
