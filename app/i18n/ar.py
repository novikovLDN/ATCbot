...
LANG = {
    ...
    'setup.key_Pro_label': "🔑 <b>مفتاح Pro</b> (القوائم البيضاء RU):",
    ...
    'setup.qr_Pro_unavailable': "❌ Pro Pro غير متاح.\n\nتأكد من أن لديك اشتراك نشط وحركة Pro.",
    ...
    'traffic.info': "📊 <b>Pro الحظر</b> 🇷🇺\n\n📥 {used} / {limit}\n{bar} {pct}%\n\n⏳ حتى: {expires}\n\n🔗 <b>مفتاح Pro</b> <i>(اضغط للنسخ)</i>\n<blockquote expandable><code>{sub_url}</code></blockquote>\n\n📲 <b>أين تلصق:</b>\n└ <b>Happ</b> → الرئيسية → <b>+</b> → لصق من الحافظة",
    'traffic.no_subscription': "📊 <b>Pro الحظر</b> 🇷🇺\n\n🔒 لا يوجد اشتراك نشط.",
    'traffic.trial_no_Pro': "📊 <b>Pro الحظر</b> 🇷🇺\n\n🔒 Pro متاح في خطط Basic و Plus.",
    'traffic.not_provisioned': "📊 لم يتم إعداد Pro بعد. حاول لاحقاً.",
    'traffic.fetch_error': "⚠️ فشل تحميل بيانات حركة المرور. حاول لاحقاً.",
    'traffic.warning_low': "متبقي {remaining} من حركة المرور",
    'traffic.warning_critical': "حركة مرور Pro على وشك النفاد!",
    'traffic.subscription_expired_Pro_active': "⚠️ <b>انتهى اشتراكك الأساسي</b>\n\nيستمر Pro الحظر في العمل — الجيجابايت الخاصة بك سليمة.\n\nلا تنسَ شراء المزيد من حركة المرور إذا كانت على وشك النفاد 👇",
    ...
    'traffic.notify_3gb': "⚠️ متبقي {remaining} من حركة مرور Pro 🇷🇺\n\nاشترِ حركة مرور إضافية.",
    'traffic.notify_1gb': "🔴 أقل من 1 جيجابايت! سيتوقف Pro قريباً.",
    'traffic.notify_500mb': "❗️ متبقي فقط {remaining} من حركة المرور!",
    'traffic.notify_zero': "🚫 نفدت حركة مرور Pro.\n\nAtlas Fast 🇩🇪 يستمر بالعمل بدون حدود.",
}
