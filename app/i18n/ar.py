...
LANG = {
    ...
    'setup.connect_ios': "📱 <b>الاتصال على iOS</b>\n\n<b>1. انسخ المفتاح</b> — اضغط عليه أدناه\n\n<b>2. افتح التطبيق:</b>\n\n▸ <b>Happ</b> — اضغط على أيقونة الحافظة 🗒️ في الأسفل → يُضاف المفتاح تلقائياً → اضغط زر الاتصال\n\n▸ <b>V2RayTun</b> — اضغط <b>+</b> أعلى اليمين → «استيراد من الحافظة» → اضغط زر الاتصال\n\n▸ <b>Hiddify</b> — اضغط <b>+</b> → «إضافة من الحافظة» → اضغط زر الاتصال",
    'setup.connect_android': "🤖 <b>الاتصال على Android</b>\n\n<b>1. انسخ المفتاح</b> — اضغط عليه أدناه\n\n<b>2. افتح التطبيق:</b>\n\n▸ <b>Happ</b> — اضغط على أيقونة الحافظة 🗒️ في الأسفل → يُضاف المفتاح تلقائياً → اضغط زر الاتصال\n\n▸ <b>V2RayTun</b> — اضغط <b>+</b> أعلى اليمين → «استيراد من الحافظة» → اضغط زر الاتصال\n\n▸ <b>Hiddify</b> — اضغط <b>+</b> → «إضافة من الحافظة» → اضغط زر الاتصال",
    'setup.connect_macos': "🍎 <b>الاتصال على macOS</b>\n\n<b>1. انسخ المفتاح</b> — اضغط عليه أدناه\n\n<b>2. افتح التطبيق:</b>\n\n▸ <b>Happ</b> — اضغط على أيقونة الحافظة 🗒️ في الأسفل → يُضاف المفتاح تلقائياً → اضغط زر الاتصال\n\n▸ <b>V2RayTun</b> — اضغط <b>+</b> أعلى اليمين → «استيراد من الحافظة» → اضغط زر الاتصال\n\n▸ <b>Hiddify</b> — اضغط <b>+</b> → «إضافة من الحافظة» → اضغط زر الاتصال",
    'setup.connect_windows': "🪟 <b>الاتصال على Windows</b>\n\n<b>1. انسخ المفتاح</b> — اضغط عليه أدناه\n\n<b>2. افتح التطبيق:</b>\n\n▸ <b>Hiddify</b> — اضغط <b>+</b> → «إضافة من الحافظة» → اضغط زر الاتصال\n\n▸ <b>v2rayN</b> — افتح قائمة <b>الخوادم</b> → «استيراد من الحافظة» → اضغط زر الاتصال",
