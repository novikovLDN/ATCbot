...
LANG = {
    ...
    'traffic.menu_button': "📊 حركة المرور (روسيا 🇷🇺)",
    'traffic.info': "📊 حركة المرور (روسيا 🇷🇺)\n━━━━━━━━━━━━━━━━━━━━\nمستخدم: {used} جيجابايت / {limit} جيجابايت\n{bar} {pct}%\n━━━━━━━━━━━━━━━━━━━━\n{warn} متبقي: {remaining} جيجابايت",
    'traffic.buy_button': "💳 شراء حركة المرور",
    'traffic.buy_header': "📦 اختر باقة حركة المرور",
    'traffic.current_remaining': "المتبقي الحالي: {remaining} جيجابايت / {limit} جيجابايت",
    'traffic.confirm_purchase': "شراء {gb} جيجابايت مقابل {price} ₽؟\n\nسيتم خصم المبلغ من رصيدك.",
    'traffic.pay_balance': "💳 دفع {price} ₽ من الرصيد",
    'traffic.insufficient_balance': "رصيد غير كافٍ.\nالمطلوب: {price} ₽\n\nيرجى شحن رصيدك.",
    'traffic.topup_button': "💳 شحن الرصيد",
    'traffic.payment_failed': "فشل الدفع. يرجى المحاولة لاحقاً.",
    'traffic.purchase_success': "✅ تمت إضافة حركة المرور!\n\n📊 الرصيد الجديد: {remaining} جيجابايت / {limit} جيجابايت\n{bar} {pct}%",
    'traffic.purchase_success_no_stats': "✅ تمت إضافة {gb} جيجابايت!",
    'traffic.view_traffic': "📊 حركة المرور",
    'traffic.unavailable': "خادم Yandex غير متاح مؤقتاً.",
    'traffic.no_account': "ليس لديك اشتراك نشط لخادم Yandex.",
    'traffic.fetch_error': "فشل تحميل بيانات حركة المرور. يرجى المحاولة لاحقاً.",
    'traffic.notify_3gb': "⚠️ متبقي {remaining} فقط على خادم Yandex",
    'traffic.notify_1gb': "🔴 أقل من 1 جيجابايت متبقي! سيتم تقييد الاتصال قريباً",
    'traffic.notify_500mb': "❗️ متبقي {remaining} فقط! اشترِ حركة مرور للمتابعة",
    'traffic.notify_0': "🚫 نفدت حركة المرور على خادم Yandex. الخوادم الأخرى تعمل بدون قيود.",
}
