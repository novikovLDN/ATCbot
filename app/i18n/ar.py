...
LANG = {
    ...
    'traffic.warning_device_limit': "تم الوصول إلى حد الأجهزة. افصل جهازاً أو أعد تعيين جميع الاتصالات.",
    'traffic.reset_devices_btn': "🔄 إعادة تعيين الاتصالات",
    'traffic.reset_devices_confirm': "⚠️ <b>إعادة تعيين الاتصالات</b>\n\nسيتم فصل جميع الأجهزة.\nستحتاج إلى إعادة الاتصال على كل جهاز.\n\nهل أنت متأكد؟",
    'traffic.reset_devices_confirm2': "🔴 <b>تأكيد إعادة التعيين</b>\n\nسيؤدي هذا إلى فصل جميع أجهزتك.\nستحتاج إلى إعداد الاتصالات مرة أخرى.\n\nاضغط «تأكيد» لإعادة التعيين.",
    'traffic.reset_devices_success': "✅ تم إعادة تعيين جميع الاتصالات.\n\nأعد توصيل أجهزتك باستخدام رابط الاشتراك.",
    'traffic.reset_devices_error': "❌ فشل إعادة التعيين. حاول لاحقاً.",
    'traffic.reset_devices_confirm_btn': "✅ تأكيد إعادة التعيين",
    'traffic.reset_devices_cancel_btn': "❌ إلغاء",
