...
LANG = {
    ...
    'buy.tariff_plus': '👑 Plus — عندما تكون الموثوقية مهمة\nأقصى استقرار + سرعة أولوية ⚡️',
    'buy.tariff_plus_desc': '👑 الباقة: Plus\n\nمتصل دائماً — اتصال مستقر في أي ظروف\n\n⚡ سرعة أولوية للبث والألعاب\n🛡 حماية معززة وتشفير حركة المرور\n🇪🇺 خوادم مخصصة في عدة دول\n🔄 مسارات احتياطية — الاتصال يعمل دائماً\n\n👉 موثوقية وحرية قصوى بدون أي تنازلات',
