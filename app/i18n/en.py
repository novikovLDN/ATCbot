...
LANG = {
    ...
    'traffic.menu_button': "📊 Traffic (Russia 🇷🇺)",
    'traffic.info': "📊 Traffic (Russia 🇷🇺)\n━━━━━━━━━━━━━━━━━━━━\nUsed: {used} GB / {limit} GB\n{bar} {pct}%\n━━━━━━━━━━━━━━━━━━━━\n{warn} Remaining: {remaining} GB",
    'traffic.buy_button': "💳 Buy traffic",
    'traffic.buy_header': "📦 Choose a traffic pack",
    'traffic.current_remaining': "Current remaining: {remaining} GB / {limit} GB",
    'traffic.confirm_purchase': "Buy {gb} GB of traffic for {price} ₽?\n\nAmount will be deducted from your balance.",
    'traffic.pay_balance': "💳 Pay {price} ₽ from balance",
    'traffic.insufficient_balance': "Insufficient balance.\nRequired: {price} ₽\n\nPlease top up your balance.",
    'traffic.topup_button': "💳 Top up balance",
    'traffic.payment_failed': "Payment failed. Please try again later.",
    'traffic.purchase_success': "✅ Traffic added!\n\n📊 New balance: {remaining} GB / {limit} GB\n{bar} {pct}%",
    'traffic.purchase_success_no_stats': "✅ Added {gb} GB of traffic!",
    'traffic.view_traffic': "📊 My traffic",
    'traffic.unavailable': "Yandex server is temporarily unavailable.",
    'traffic.no_account': "You don't have an active subscription for Yandex server.",
    'traffic.fetch_error': "Failed to fetch traffic data. Please try again later.",
    'traffic.notify_3gb': "⚠️ Only {remaining} of traffic left on Yandex server",
    'traffic.notify_1gb': "🔴 Less than 1 GB remaining! Connection will be limited soon",
    'traffic.notify_500mb': "❗️ Only {remaining} left! Buy traffic to continue",
    'traffic.notify_0': "🚫 Traffic on Yandex server exhausted. Other servers continue to work without restrictions.",
