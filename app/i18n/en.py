...
LANG = {
    ...
    'buy.tariff_plus': "👑 Plus — when reliability matters\nMaximum stability + priority speed ⚡️",
    'buy.tariff_plus_desc': "👑 Tariff: Plus\n\nAlways connected — stable connection in any conditions\n\n⚡ Priority speed for streaming and gaming\n🛡 Enhanced protection and traffic encryption\n🇪🇺 Dedicated servers in multiple countries\n🔄 Backup routes — connection always works\n\n👉 Maximum reliability and freedom with no compromises",
