...
LANG = {
    ...
    'traffic.warning_device_limit': "Device limit reached. Disconnect a device or reset all connections.",
    'traffic.reset_devices_btn': "🔄 Reset connections",
    'traffic.reset_devices_confirm': "⚠️ <b>Reset connections</b>\n\nAll devices will be disconnected.\nYou will need to reconnect on each device.\n\nAre you sure?",
    'traffic.reset_devices_confirm2': "🔴 <b>Confirm reset</b>\n\nThis will disconnect ALL your devices.\nYou will need to set up connections again.\n\nPress «Confirm» to reset.",
    'traffic.reset_devices_success': "✅ All connections have been reset.\n\nReconnect your devices using the subscription link.",
    'traffic.reset_devices_error': "❌ Failed to reset connections. Try again later.",
    'traffic.reset_devices_confirm_btn': "✅ Confirm reset",
    'traffic.reset_devices_cancel_btn': "❌ Cancel",
