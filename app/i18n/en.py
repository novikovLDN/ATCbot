...
LANG = {
    ...
    'games.bomber_paywall': "💣 Bomber is for subscribers only!\n\nPurchase a subscription to play.",
    'games.games_club_paywall': "🎮 Game club is for subscribers only!\nGet a subscription to access all games 🎯",
    ...
    'farm.button_buy_plot_remaining': '➕ Buy plot — 50 ₽ (slots left: {remaining})',
    'farm.button_buy_plot_disabled_remaining': '➕ Plot (need 50 ₽, slots left: {remaining})',
    'farm.instructions': '📖 Instructions',
    'farm.dig_confirm_title': "⛏ <b>Dig up the plant?</b>\n\nDo you want to dig up <b>{name}</b> on plot {num}?\n\n⚠️ The plant will be destroyed without reward.\nThe plot will be empty and you can plant a new one.",
    'farm.dig_confirm_yes': '⛏ Yes, dig up',
    'farm.dig_confirm_no': '❌ No',
    'farm.dig_success': '⛏ Plant dug up! Plot is free.',
    'farm.error_dig_unavailable': '❌ Plant is not available for digging',
