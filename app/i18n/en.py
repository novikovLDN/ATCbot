...
LANG = {
    ...
    'get_key.instruction_text': "📖 <b>Connection Guide</b>\n\n<b>Happ</b> — open the app → tap the clipboard icon 🗒️ at the bottom → the key will be added automatically\n\n<b>V2RayTun</b> — open the app → tap <b>+</b> in the top right corner → «Import from clipboard»\n\n⸻\n\n👇 Tap the key to copy:",
    'get_key.no_subscription': "❌ You don't have an active subscription.",
    'setup.auto_happ': "⚡ Auto setup Happ",
    'setup.auto_hiddify': "⚡ Auto setup Hiddify",
    'setup.auto_v2raytun': "⚡ Auto setup V2RayTun",
    'setup.connect_ios': "📱 <b>Connect on iOS</b>\n\n<b>1. Copy the key</b> — tap it below\n\n<b>2. Open the app:</b>\n\n▸ <b>Happ</b> — tap the clipboard icon 🗒️ at the bottom → the key will be added automatically → tap the connect button\n\n▸ <b>V2RayTun</b> — tap <b>+</b> in the top right → «Import from clipboard» → tap the connect button\n\n▸ <b>Hiddify</b> — tap <b>+</b> → «Add from clipboard» → tap the connect button",
    'setup.connect_android': "🤖 <b>Connect on Android</b>\n\n<b>1. Copy the key</b> — tap it below\n\n<b>2. Open the app:</b>\n\n▸ <b>Happ</b> — tap the clipboard icon 🗒️ at the bottom → the key will be added automatically → tap the connect button\n\n▸ <b>V2RayTun</b> — tap <b>+</b> in the top right → «Import from clipboard» → tap the connect button\n\n▸ <b>Hiddify</b> — tap <b>+</b> → «Add from clipboard» → tap the connect button",
    'setup.connect_macos': "🍎 <b>Connect on macOS</b>\n\n<b>1. Copy the key</b> — tap it below\n\n<b>2. Open the app:</b>\n\n▸ <b>Happ</b> — tap the clipboard icon 🗒️ at the bottom → the key will be added automatically → tap the connect button\n\n▸ <b>V2RayTun</b> — tap <b>+</b> in the top right → «Import from clipboard» → tap the connect button\n\n▸ <b>Hiddify</b> — tap <b>+</b> → «Add from clipboard» → tap the connect button",
    'setup.connect_windows': "🪟 <b>Connect on Windows</b>\n\n<b>1. Copy the key</b> — tap it below\n\n<b>2. Open the app:</b>\n\n▸ <b>Hiddify</b> — click <b>+</b> → «Add from clipboard» → click the connect button\n\n▸ <b>v2rayN</b> — open <b>Servers</b> menu → «Import from clipboard» → click the connect button",
