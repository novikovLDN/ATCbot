...
LANG = {
    ...
    'games.bowling_strike_success': "🎳 Strike! All pins knocked down!\n\n🎉 Congratulations! You won +7 days subscription.\n\nAccess until: {date}",
    'games.bowling_strike_error': "🎳 Strike! All pins knocked down!\n\n🎉 Congratulations! You won +7 days subscription.\n\n⚠️ Error crediting. Please contact support.",
    ...
    'main.trial_expired_text': "🔓 Trial access ended\n\nYour trial period has expired.\n\n🎟 Use promo code YAbx30 for 30% discount on your first subscription.\n\nSubscribe now to continue using secure access.",
    ...
    'payment.success_first': "🎉 Subscription successfully activated\n\n📅 Valid until: {date}\n\n🔐 Your connection key:\n<code>{vpn_key}</code>\n\nYou can use it in the VPN app.",
    'payment.success_renewal': "🔄 Subscription renewed\n\n📅 New validity: until {date}\n\n🔐 Your current key (same UUID):\n<code>{vpn_key}</code>\n\nYou can continue using your current connection key.",
    ...
    'trial.expired': "🔓 Trial access ended\n\nYour trial period has expired.\n\n🎟 Use promo code YABX30 for 30% discount on your first subscription.\n\nSubscribe now to continue using secure access.",
    ...
    'gift.detail_pending': "🎁 Send this gift to someone special!\n\n📦 Plan: {tariff_name}\n⏳ Period: {period}\n\n❌ Not activated\n\n🔗 Activation link:\n<code>{gift_link}</code>",
    ...
    'farm.choose_plant_title': '🌱 Choose a plant for plot {num}:',
