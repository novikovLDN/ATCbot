...
LANG = {
    ...
    'profile.status_pending': "⏳ Subscription: activating — your key will be ready in a minute",
    'profile.tariff_trial': "🎁 Trial",
    'profile.panel_unavailable': "\n\n⚠️ <i>Panel data is temporarily unavailable: showing what the database says, the bypass traffic balance is not refreshed.</i>",
    'main.my_sub_pending': "activating…",
