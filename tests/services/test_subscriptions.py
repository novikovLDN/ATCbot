...
class TestParseExpiresAt:
    ...
    def test_parse_datetime(self):
        """Naive datetime should be returned as UTC-aware"""
...
class TestIsSubscriptionActive:
    ...
    def test_active_subscription(self):
        ...
        future = datetime(2024, 2, 15, 12, 0, 0, tzinfo=timezone.utc)
        subscription = {
            "status": "active",
            "expires_at": future,
            "uuid": "test-uuid",
...
class TestGetSubscriptionStatus:
    ...
    def test_uses_current_time_if_not_provided(self):
        ...
        future = datetime(2099, 2, 15, 12, 0, 0, tzinfo=timezone.utc)
        subscription = {
            "status": "active",
            "expires_at": future,
            "uuid": "test-uuid",
