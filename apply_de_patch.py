#!/usr/bin/env python3
"""Apply translation_patch_de.json to app/i18n/de.py."""
...
PATCH_FILE = ROOT / "translation_patch_de.json"
DE_FILE = ROOT / "app" / "i18n" / "de.py"
...
def main() -> int:
    ...
    lines = ["# -*- coding: utf-8 -*-", '"""de strings."""', "", "LANG = {"]
    ...
    try:
        exec(DE_FILE.read_text(encoding="utf-8"), {})
    except SyntaxError as e:
        print(f"ERROR: Syntax error: {e}", file=sys.stderr)
        return 1

    print(f"Applied {applied} translations to {DE_FILE}")
