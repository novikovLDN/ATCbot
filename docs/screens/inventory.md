...
| Step 2: Copy & import VPN keys into app | `setup.key_install_title_agg` | `setup_step2:`… | `app/handlers/callbacks/navigation.py:589` `callback_setup_step2` | navigation.py | ✅ | 2026-09-03 `92959eaf` revert(moderation): модерация перенесена — верну |  |
