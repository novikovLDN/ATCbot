...
TEXTS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "vip_access_text": "VIP-доступ Atlas Secure\n\nVIP — это уровень доступа,\nпредоставляемый избирательно.\n\nОн не продаётся и рассматривается индивидуально\nна основании доверия и истории взаимодействия\nс инфраструктурой Atlas Secure.\n\n⸻\n\nПривилегии уровня\n\n— приоритетная инфраструктура и минимальная латентность\n— персональная конфигурация VPN-доступа\n— расширенное сопровождение и прямой контакт\n— дискреционные условия при продлении\n— ранний доступ к инфраструктурным изменениям\n— закрытая коммуникация по ключевым обновлениям\n\nВсе решения принимаются вручную.\nАвтоматические механизмы не используются.",
