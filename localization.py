...
TEXTS: Dict[str, Dict[str, str]] = {
    ...
    "uz": {
        ...
        "crypto_invoice_created": "₿ Kriptovalyuta to'lovi\n\nSumma: {amount:.2f} ₽\n\nTo'lov sahifasiga o'tish uchun quyidagi tugmani bosing.\n\nTo'lovdan keyin \"To'lovni tekshirish\" tugmasini bosing.",
    ...
    "tj": {
        ...
        "crypto_invoice_created": "₿ Пардохти крипто валюта\n\nМаблағ: {amount:.2f} ₽\n\nБарои гузаштан ба саҳифаи пардохт тугмаи поёнро пахш кунед.\n\nПас аз пардохт тугмаи \"Пардохтро санҷед\"-ро пахш кунед.",
