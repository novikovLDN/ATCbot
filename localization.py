...
TEXTS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        # Главное меню
        "welcome": "Atlas Secure — защищённый доступ в интернет\n\nВы получаете персональный ключ для подключения.\nОн работает на всех ваших устройствах: телефон, ноутбук, планшет.\n\nПодключение стабильное, без ограничений скорости.\nВаши данные защищены.\n\nВсё просто. Всё работает.",
        "profile": "👤 Мой профиль",
        ...
        "renew_subscription": "🔁 Продлить на тот же период",
        ...
        "tariff_button_1": "1 месяц Временный доступ · 149 ₽",
        "tariff_button_3": "3 месяца Стандартный доступ · 399 ₽",
        "tariff_button_6": "6 месяцев Расширенный доступ · 599 ₽",
        "tariff_button_12": "12 месяцев Приоритетный доступ · 899 ₽",
        ...
        "vip_access_button": "👑 VIP-доступ",
        "vip_access_text": "VIP-доступ\n\nРасширенный уровень обслуживания\nдля постоянных пользователей.\n\n⸻\n\nЧто входит\n\n• Приоритетная поддержка\n• Персональная настройка подключения\n• Резервные каналы связи\n• Гибкие условия продления\n• Уведомления об обновлениях\n\n⸻\n\nКак получить\n\nVIP-доступ предоставляется\nпостоянным пользователям сервиса.\n\nЕсли вы хотите узнать о возможности\nполучения VIP-статуса,\nсвяжитесь с нами через поддержку.",
        ...
        "no_subscription": "У вас нет активного доступа.\n\nЧтобы начать пользоваться сервисом,\nвыберите срок подписки и оплатите.\n\nПосле оплаты вы получите ключ\nи сможете подключиться за минуту.",
        
        # О сервисе
        "about_text": "Почему Atlas Secure\n\n🔐 Защита данных\n\nВаше соединение зашифровано.\nТо же шифрование, что используют банки.\n\n🧬 Мы не храним вашу активность\n\nНе записываем, куда вы заходите.\nНе сохраняем историю подключений.\nНечего хранить — нечего раскрыть.\n\n⚡ Стабильная работа\n\nСерверы оптимизированы для скорости.\nНет искусственных ограничений.\nПодключение не падает.\n\n📱 Один ключ — все устройства\n\nТелефон, ноутбук, планшет.\niOS, Android, Windows, macOS.\nОдин ключ работает везде.\n\n⸻\n\nКому подходит\n\n• Предпринимателям и фрилансерам\n• Тем, кто работает с важными данными\n• Путешественникам\n• Всем, кому нужен стабильный доступ\n\n⸻\n\nКак это работает\n\nВы получаете персональный ключ.\nПодключаетесь через приложение Outline.\nВсё работает автоматически.\n\nПросто. Надёжно. Без лишнего.",
        "privacy_policy": "Политика конфиденциальности",
        "privacy_policy_text": "Политика конфиденциальности Atlas Secure\n\nAtlas Secure использует принцип минимизации данных.\nМы не собираем информацию, которая не требуется для работы сервиса.\n\n⸻\n\nЧто мы не храним\n\n— историю подключений\n— IP-адреса и трафик\n— DNS-запросы\n— данные о посещаемых ресурсах\n— метаданные активности\n\nИспользуется архитектура Zero-Logs.\n\n⸻\n\nЧто может обрабатываться\n\n— статус и срок действия доступа\n— технический идентификатор VPN-ключа\n\nЭти данные не связаны с пользовательской активностью.\n\n⸻\n\nПлатежи\n\nПлатёжные данные не обрабатываются и не хранятся Atlas Secure.\nОплата проходит через банковские каналы вне нашей инфраструктуры.\n\n⸻\n\nПередача данных\n\nМы не передаём данные третьим лицам\nи не используем трекеры, аналитику или рекламные SDK.\n\n⸻\n\nПоддержка\n\nОбрабатывается только информация, добровольно предоставленная пользователем\nдля решения конкретного запроса.\n\n⸻\n\nAtlas Secure\nКонфиденциальность — основа архитектуры.",
        "service_status": "📜 Статус сервиса",
        "service_status_text": "📜 Статус сервиса Atlas Secure\n\nТекущий статус: 🟢 Оперативный режим\n\nВсе основные компоненты работают стабильно:\n— VPN-инфраструктура\n— Система выдачи ключей\n— Подтверждение доступов\n— Поддержка\n\n⸻\n\nSLA и обязательства\n\nAtlas Secure построен как частная цифровая инфраструктура\nс приоритетом на стабильность и предсказуемость.\n\n• Целевой аптайм: 99.9%\n• Плановые работы проводятся заранее\n• Критические инциденты обрабатываются в приоритетном порядке\n• Потеря данных исключена архитектурно\n\n⸻\n\nИнформация\n\nВ случае технических работ или изменений\nпользователи уведомляются заранее через бот.\n\nПоследнее обновление статуса: автоматически",
        ...
        # Инструкция
        "instruction_text": "Как подключиться\n\n1. Установите приложение Outline\n\nНайдите «Outline VPN» в App Store (iPhone) или Google Play (Android).\nДля компьютера — на сайте outline.net\n\n2. Получите ключ\n\nПосле оплаты вы получите персональный ключ.\nСкопируйте его.\n\n3. Вставьте ключ в приложение\n\nОткройте Outline, нажмите плюс (+)\nи вставьте ключ.\n\nГотово. Подключение работает.",
