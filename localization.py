...
TEXTS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "tariff_button_1": "1 месяц\nВременный доступ · {price} ₽",
        "tariff_button_3": "3 месяца\nСтандартный доступ · {price} ₽",
        "tariff_button_6": "6 месяцев\nРасширенный доступ · {price} ₽",
        "tariff_button_12": "12 месяцев\nПриоритетный доступ · {price} ₽",
        
        # Выбор способа оплаты
        "select_payment": "Выберите способ оплаты.",
        "payment_test": "Служебный режим\nНедоступно",
        "payment_sbp": "СБП",
